        ...
        <div className="header full-wrap" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 0 }}>
          ...
          {!isLoggedIn ? (
            <ul className="login-wrap">
              ...
              <li style={{ position: 'relative', flexDirection: 'column', top: "2px", height: 'auto', gap: '2px', alignItems: 'flex-end' }}>
                ...
                <span
                  ...
                  style={{ fontSize: '9px', color: '#ffb400', cursor: 'pointer', fontWeight: 'bold', textDecoration: 'underline', marginLeft: '1px' }}
                >
                  Forgot Password?
                </span>
              </li>
