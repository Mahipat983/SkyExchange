          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 items-start">
            ...
            <div className="xl:col-span-12 2xl:col-span-7 space-y-8 animate-in fade-in duration-500">
              ...
              <div className="bg-white border border-[#ccc] rounded-xl p-10 space-y-8 shadow-md animate-in slide-in-from-bottom-6 duration-700">
                <div style={{ background: 'transparent !important', color: '#111 !important', backgroundColor: 'transparent !important' }} className="text-[15px] font-black uppercase tracking-[0.2em] text-[#111] border-b border-[#eee] pb-6 !bg-transparent">Request Withdrawal</div>
            ...
            <div className="xl:col-span-12 2xl:col-span-5 flex flex-col min-h-[855px]">
              <div className="flex-1 flex flex-col bg-white border border-[#ccc] rounded-xl overflow-hidden shadow-md relative">
                <div className="p-6 border-b border-[#eee] flex items-center justify-between bg-white">
                  <div style={{ background: 'transparent !important', color: 'black !important', backgroundColor: 'transparent !important' }} className="text-xs font-black uppercase tracking-[0.2em] text-black !bg-transparent">Withdraw History</div>
