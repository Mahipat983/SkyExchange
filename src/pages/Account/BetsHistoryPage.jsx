            ...
            {loading ? (
              ...
              currentBetsToday.map((bet, i) => (
                <tr key={i} style={{ borderBottom: '1px solid #eee', fontSize: '13px' }}>
                  ...
                  <td style={{ padding: '12px', textAlign: 'right', color: '#000', fontSize: '11px' }}>{formatTime12h(bet.Date || bet.datetime)}</td>
                </tr>
              ))
            ) : (
              ...
              plData.map((row, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: '1px solid #eee', fontSize: '13px' }}>
                    ...
                    <td style={{ padding: '12px', textAlign: 'right', color: '#000', fontSize: '11px' }}>{formatTime12h(row.DateTime)}</td>
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: 0, fontSize: '11px', color: '#000' }}>{formatTime12h(item.DateTime)}</p>
                    </div>
                  </div>
                  ...
                  {Object.values(betDetailData || {}).filter(b => typeof b === 'object' && b !== null).map((bet, idx) => (
                    <div key={idx} style={{ background: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #7e97a7' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '15px', borderBottom: '1px solid #eee', paddingBottom: '10px' }}>
                        ...
                        <span style={{ fontSize: '11px', color: '#000', fontWeight: 'bold' }}>{formatTime12h(bet.Date)}</span>
                      </div>
