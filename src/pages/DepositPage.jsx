                      ...
                      <div className="grid grid-cols-4 sm:grid-cols-6 md:flex gap-2 md:gap-4 md:overflow-x-auto no-scrollbar pb-2">
                        {(() => {
                          ...
                          return filteredMethods.map((pm) => {
                            ...
                            // Icon Mapping (using local assets)
                          ...
                          <div className="space-y-1 animate-in fade-in duration-300">
                              ...
                              if (type === 'UPI' || type.includes('PAYTM') || type.includes('GOOGLE') || type.includes('PHONE') || type === 'GPAY') {
                                return (
                                  <>
                                    ...
                                    <AccountDetailRow label="Limits" value={`Min: ₹${activeMethod.Min || '200'} | Max: ₹${activeMethod.Max || '1cr'}`} />
                                  </>
                                );
                              }
                            ...
                            {activeMethod.Qr && (
                              <div className="pt-4 flex justify-center">
                                <div className="bg-white p-3 rounded-2xl w-64 shadow-lg active:scale-105 transition-transform cursor-pointer">
                    ...
                    <div className="bg-white border border-[#ccc] rounded-xl p-8 space-y-6 shadow-md">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="w-full h-12 bg-[#f4f4f4] border border-[#ddd] rounded-xl px-4 text-sm font-bold text-[#111] focus:outline-none transition-all"
                        />
                      </div>
                      ...
                      {activeMethod && ['CRYPTO', 'USDT'].includes((activeMethod.Type || activeMethod.type || '').toUpperCase()) && (
                        <div className="space-y-1.5 animate-in slide-in-from-bottom-2">
                          ...
                          <input
                            ...
                            className="w-full h-12 bg-[#f9f9f9] border border-[#ddd] rounded-xl px-4 text-sm font-bold text-[#111] focus:outline-none transition-all"
                          />
                        </div>
                      )}
                        ...
                        return (
                          <div key={i} className={`grid grid-cols-[1.5fr_1fr_1fr_1fr_1.5fr_1fr] items-center px-6 py-4 border-b border-[#eee] transition-all hover:bg-black/[0.02] ${i % 2 === 0 ? 'bg-transparent' : 'bg-[#fcfcfc]'}`}>
                            ...
                            <div className="flex justify-center">
                              <span className={`px-2.5 py-1 rounded-md text-[9px] font-black uppercase tracking-tighter shadow-sm border ${status === 'success' || status === 'approved'
